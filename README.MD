...
To get all the dependencies and libraries that I installed for this template, type `npm install' when you open the application for the first time in your IDE
